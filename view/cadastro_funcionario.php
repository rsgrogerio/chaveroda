...
<html>
  ...
  <div id="conteudo">
  		<form name="cad_funcionario" method="POST" action="../controller/gravar_funcionario.php">

        <h1>Cadastro de Funcionarios</h1>

		  <p class="cpf">
				<label for="cpf">CPF: </label>            
            <input type="text" id="cpfid" placeholder="Informe o CPF" name="cpf" size="30" required autofocus>
        ...
        <p class="endereco">
            ...
            <input type="text" id="cidadeid" placeholder="Informe a Cidade" name="cidade" size="30">
        ...
        <p class="telefone">
            ...
            <input type="funcao" id="funcaoid" name="funcao" placeholder="Mecanico, Eletricista ..." size="69	">    
...
$result = $conn->query("SELECT * FROM `funcionario` where ativo = 'Ativo' order by id");
$data = array();
      ...
      echo '<table width="100%" height="50" border="1" cellspacing="0">';
		...
		echo 	'<td bgcolor="lightgray" align="center"><strong>CPF </strong></td>';
	   ...
	   echo	'<td bgcolor="lightgray" align="center"><strong>Sexo </strong></td>';
		echo	'<td bgcolor="lightgray" align="center"><strong>Função </strong></td>';
